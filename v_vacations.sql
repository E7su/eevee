CREATE OR REPLACE FORCE VIEW "JIRA_READER"."V_VACATIONS" ("FIO", "DATE_START", "DATE_END", "TIME_START", "TIME_END", "REASON", "REPORTER", "ISSUENUM") AS
  SELECT
...
COMMENT ON COLUMN V_VACATIONS.REASON IS 'Причина';
